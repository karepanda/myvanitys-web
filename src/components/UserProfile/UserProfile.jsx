...
const UserProfile = () => {
	const { apiResponse, toggleUserProfile } = useContext(VanitysContext);
	...
	return (
		<div className='userProfile'>
			...
			<div className='userProfile__name'>
				...
				<h1 className='userProfile__name--title'>{apiResponse.name}</h1>
			</div>
			<div className='userProfile__buttons'>
				...
				<button className='userProfile__buttons--logOut'>Log out</button>
			</div>
		</div>
	);
};
