...
export const errorMessages = {
	...
	auth: {
		...
		500: {
			message:
				'An error occurred on the server during authentication. Please try again later.',
			title: 'Server Error',
			type: 'error',
		},
		502: {
	...
	profile: {
		400: {
			message:
				'Invalid request. Please verify your information and try again.',
			title: 'Bad Request',
			type: 'warning',
		},
		401: {
		...
		500: {
			message:
				'An error occurred on the server while retrieving the profile. Please try again later.',
			title: 'Server Error',
			type: 'error',
		},
		default: {
			message:
				'An unexpected error occurred while accessing the profile. Please try again.',
			title: 'Profile Error',
			type: 'error',
		},
	},
...
export const getErrorMessage = (category, code) => {
	...
	return (
		errorMessages[category][code] ||
		errorMessages[category].default ||
		errorMessages.generic.default
	);
};
